...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(335, 10, 131, 41))
        self.label.setObjectName("label")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(100, 80, 241, 311))
        ...
        self.pushButton_back.setGeometry(QtCore.QRect(480, 470, 112, 32))
        ...
        self.pushButton_delete.setGeometry(QtCore.QRect(530, 240, 112, 32))
        self.pushButton_delete.setFocusPolicy(QtCore.Qt.StrongFocus)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/shanchu.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_delete.setIcon(icon1)
        self.pushButton_delete.setObjectName("pushButton_delete")
        self.pushButton_update = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_update.setGeometry(QtCore.QRect(530, 200, 112, 32))
        self.pushButton_update.setFocusPolicy(QtCore.Qt.WheelFocus)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/insert.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_update.setIcon(icon2)
        self.pushButton_update.setObjectName("pushButton_update")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(430, 130, 321, 41))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton_logout = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_logout.setGeometry(QtCore.QRect(620, 470, 112, 32))
        ...
        self.pushButton_add.setGeometry(QtCore.QRect(530, 280, 112, 32))
        self.pushButton_add.setFocusPolicy(QtCore.Qt.StrongFocus)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/zengjia.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
